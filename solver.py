...
class Solver(object):
    ...
    def __init__(self, config):
        ...
        self.thre_loader = get_loader_segment(self.data_path, batch_size=self.batch_size, win_size=self.win_size,
                                              mode='thre',
                                              dataset=self.dataset)
        self.full_loader = get_loader_segment(self.data_path, batch_size=self.batch_size, win_size=self.win_size,
                                              mode='full',
                                              dataset=self.dataset)
    ...
    def test(self):
        ...
        print(self.thre_loader)
        for i, input_data in enumerate(self.full_loader):  #for i, (input_data, labels) in enumerate(self.thre_loader):
        ...
        pred = np.array(pred)
        pd.DataFrame(pred).to_csv(f"{self.dataset}_{self.mode}_label.csv", index=False, header=False)
