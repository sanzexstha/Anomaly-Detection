...
python main.py --anormly_ratio 3 --num_epochs 1  --batch_size 32  --mode train --dataset SMAP  --data_path dataset/SMAP --input_c 25    --output_c 25

python main.py --anormly_ratio 10  --num_epochs 1       --batch_size 32     --mode test    --dataset SMAP   --data_path dataset/SMAP  --input_c 25    --output_c 25  --pretrained_model 20
