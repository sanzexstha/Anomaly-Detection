...
from ablations.Attentions.models import dozerformer_Linear_attention_ablation
from ablations.Channel_dependent import dozerformer_Linear_CD
from ablations.Trend_models import dozerformer_Trend_models
from utils.tools import EarlyStopping, adjust_learning_rate, visual, process_one_batch
from utils.metrics import metric
from models.my_method.build_model_util import hierarchical_load_pretrain_model, L1CharbonnierLossColor
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            ...
            'dozerformer_Linear_attention_ablation': dozerformer_Linear_attention_ablation,
            'dozerformer': dozerformer,
            'dozerformer_Linear_CD': dozerformer_Linear_CD,
            'dozerformer_Trend_models': dozerformer_Trend_models
        }
        #这里注意模型的数据类型
    ...
    def _select_criterion(self):
        ...
        # criterion = L1CharbonnierLossColor()
        return criterion
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            # TODO Remember to delete it sometime later.
            self.model.epoch += 1
