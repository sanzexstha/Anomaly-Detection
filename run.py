...
def main():
    ...
    parser.add_argument('--model', type=str, default='No model id provided',
    ...
    parser.add_argument('--patch_size', type=int, default=12, help='patch sizes of hierarchical architecture')
    ...
    parser.add_argument('--trend_model_id', type=str, default='None', help='LSTM, Dozerformer')
    ...
    args.vary_len = 3
    args.pred_len = 336
    # args.abla_type = 'Trend_models'
    # args.trend_model_id = 'LSTM'

    # 12345 is flag for removal of vary_len part.
    args.vary_len = False if args.vary_len == 12345 else args.vary_len
    ...
    # 这个dff参数在定义自注意力机制时被使用. dimension of MLP in transformer
    ...
    data_parser = {
        ...
        'Synthetic': {'data': 'Synthetic.csv', 'data_dim': 7, 'split': [0.7, 0.1, 0.2]},
    }
    ...
    if args.wandb==True:
        wandb.login()
        wandb.init(project="Dozerformer", config=args)
        # args = wandb.config
